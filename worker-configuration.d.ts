// Generated by Wrangler by running `wrangler types` (hash: 7b1fd5561a5eb1e86cc7eb634db59f91)
// Runtime types generated with workerd@1.20250405.0 2025-04-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OAUTH_KV: KVNamespace;
		RPC_URL: string;
		FUNGIBLE_PAUSABLE_WASM_HASH: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RPC_URL" | "FUNGIBLE_PAUSABLE_WASM_HASH" | "NETWORK_PASSPHRASE" | "LAUNCHTUBE_URL" | "LAUNCHTUBE_JWT">> {}
}
